...
final class EmojiView extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private static int emojiTabLastSelectedIndex = -1;
    ...
    EmojiView(final Context context,
        ...
        emojisPager.setOffscreenPageLimit(2);
    ...
    static class EmojiTabsClickListener implements OnClickListener {
        ...
        public void onClick(final View v) {
            emojisPager.setCurrentItem(position, false);
        }
    }

    public static boolean isRecentEmojiTabSelected() {
        return 0 == emojiTabLastSelectedIndex;
    }
}
