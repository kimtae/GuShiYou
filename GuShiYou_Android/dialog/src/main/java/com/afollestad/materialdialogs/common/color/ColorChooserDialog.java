...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public final static String ARGUMENTS_BUILDER = "builder";
    public final static String ARGUMENTS_DEFAULT_COLOR = "default_color";
    ...
    private TextView mRestoreDefualt;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mDefaultColor = getArguments().getInt(ARGUMENTS_DEFAULT_COLOR);
            if (null != getBuilder()) {
                mCallback = getBuilder().mColorCallback;
            }
        }
    }
    ...
    private void invalidateDynamicButtonColors() {
        ...
        if (builder.mDynamicButtonColor) {
            ...
            if (getBuilder().mDynamicButtonColor) {
                ...
                mRestoreDefualt.setTextColor(selectedColor);
            }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (getArguments() == null || !getArguments().containsKey(ARGUMENTS_BUILDER))
        ...
        if (builder.mAllowUserCustom) {
            ...
            mRestoreDefualt = (TextView) v.findViewById(R.id.md_restore_default);
            ...
            mRestoreDefualt.setText(builder.mRestoreDefaultBtn);
            mRestoreDefualt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (!builder.mAllowUserCustomAlpha) {
                        mCustomColorHex.setText(Integer.toHexString(mDefaultColor).toUpperCase().substring(2));
                    } else {
                        mCustomColorHex.setText(Integer.toHexString(mDefaultColor).toUpperCase());
                    }
                }
            });
            ...
            if (!builder.mAllowUserCustomAlpha) {
                ...
                mCustomColorHex.setHint(Integer.toHexString(mDefaultColor).toUpperCase().substring(2));
                mCustomColorHex.setFilters(new InputFilter[]{new InputFilter.LengthFilter(6)});
            } else {
                mCustomColorHex.setHint(Integer.toHexString(mDefaultColor).toUpperCase());
    ...
    public static class Builder implements Serializable {
        ...
        @NonNull
        protected final transient AppCompatActivity mActivity;
        protected final transient ColorCallback mColorCallback;
        @StringRes
        ...
        @StringRes
        protected int mRestoreDefaultBtn = R.string.md_restore_default_label;
        @Nullable
        ...
        public <ActivityType extends AppCompatActivity> Builder(@NonNull ActivityType activity, @StringRes int title, ColorCallback colorCallback) {
            mActivity = activity;
            mTitle = title;
        ...
        @NonNull
        public Builder restoreDefaultButton(@StringRes int restoreDefaultBtn) {
            mRestoreDefaultBtn = restoreDefaultBtn;
            return this;
        }
        ...
        public Builder customColors(@ArrayRes int topLevel, @Nullable int[][] subLevel) {
            mColorsTop = DialogUtils.getColorArray(mActivity, topLevel);
            mColorsSub = subLevel;
            return this;
        }
        ...
        public ColorChooserDialog build() {
            ...
            args.putSerializable(ARGUMENTS_BUILDER, this);
            args.putSerializable(ARGUMENTS_DEFAULT_COLOR, mDefaultColor);
    ...
    private Builder getBuilder() {
        if (getArguments() == null || !getArguments().containsKey(ARGUMENTS_BUILDER)) return null;
        return (Builder) getArguments().getSerializable(ARGUMENTS_BUILDER);
    }
