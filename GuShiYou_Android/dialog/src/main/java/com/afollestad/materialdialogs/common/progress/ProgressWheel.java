package com.afollestad.materialdialogs.common.progress;
...
public class ProgressWheel extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int viewWidth = 2 * circleRadius + this.getPaddingLeft() + this.getPaddingRight();
        int viewHeight = 2 * circleRadius + this.getPaddingTop() + this.getPaddingBottom();
